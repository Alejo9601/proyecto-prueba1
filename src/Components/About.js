    ...
    <section className="about">
      ...
      <div className="flex-container" id="flex-about">
        <section className="about-description">
          ...
          I am always seeking to improve my skills and continue growing professionally in order to make valuable contributions at the working group I am part of. 
          Therefore I use the modern development workflow with CodeStream in order to increase productivity and improve communication inside our development team.
          </p>
        </section>
        <section className="grid-container about-skills">
          ...
          <div className="skill" id="node.js">NODE.JS</div>
